...
// you need to filter out the objects where the birth rate value is greater than
// 15 per 1000 chickens for that year. Store the good years in a new array named `bestYears`.
const bestYears = []
const birthRates = [
